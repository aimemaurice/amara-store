      ...
      <main className="mx-auto flex min-h-[calc(100vh-112px)] max-w-3xl items-center px-4 py-16 sm:px-6 lg:px-8">
        <div className="w-full rounded-[2rem] border border-slate-200 bg-slate-50 p-10 shadow-sm">
          <div className="mb-8 text-center">
            <p className="text-sm uppercase tracking-[0.3em] text-[#C9A84C]">Welcome back</p>
            <h1 className="mt-4 text-4xl font-bold">Login to AMARA</h1>
          </div>
          ...
          <p className="mt-8 text-center text-sm text-slate-600">
            ...
            <Link to="/register" className="font-semibold text-[#C9A84C] hover:text-[#a98329]">
              Register here
            </Link>
          </p>
        </div>
